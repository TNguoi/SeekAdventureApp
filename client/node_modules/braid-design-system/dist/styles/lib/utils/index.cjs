...
function findClosestAccessibleLighterColor(inputColor, fixedColor, contrastRatio = AA_TEXT_CONTRAST) {
  ...
  let maxColor = polished.hslToColorString({ hue, saturation, lightness: maxLightness });
...
const mapToProperty = (property, breakpoint) => (value) => {
  ...
  return breakpoint ? styles_lib_css_responsiveStyle_cjs.responsiveStyle({ [breakpoint]: styleRule }) : styleRule;
};
