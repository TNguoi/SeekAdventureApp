...
const snippets$C = [{
  ...
  code: '<Card tone="promote">\n        <Stack space="gutter">\n          <Placeholder height={200} />\n        </Stack>\n      </Card>'
}, {
  name: "With formAccent tone",
  code: '<Card tone="formAccent">\n        <Stack space="gutter">\n          <Placeholder height={200} />\n        </Stack>\n      </Card>'
}, {
...
const snippets$B = [{
  ...
  name: "Small",
  code: '<Checkbox label="Label" size="small" />'
}, {
  name: "With a critical message",
  code: '<Checkbox label="Label" tone="critical" message="Critical message" />'
}, {
  name: "With a description",
  code: '<Checkbox label="Label" description="Description" />'
}, {
  name: "With a Badge",
  code: '<Checkbox label="Label" badge={<Badge weight="strong">Badge</Badge>} />'
}, {
...
const snippets$z = [{
  ...
  name: "Xsmall",
  code: '<ContentBlock width="xsmall">\n        <Placeholder height={100} />\n      </ContentBlock>'
}, {
  name: "Small",
  code: '<ContentBlock width="small">\n        <Placeholder height={100} />\n      </ContentBlock>'
}, {
  name: "Large",
...
const snippets$y = [{
  ...
  name: "Small",
  code: '<Dialog title="Dialog Heading" width="small" open={true}>\n        <Placeholder width="100%" height={100} />\n      </Dialog>'
}, {
  name: "Medium",
  code: '<Dialog title="Dialog Heading" width="medium" open={true}>\n        <Placeholder width="100%" height={100} />\n      </Dialog>'
}, {
  name: "Large",
...
const snippets$v = [{
  ...
  name: "Small",
  code: '<Drawer title="Drawer Heading" width="small" open={true}>\n        <Placeholder width="100%" height={100} />\n      </Drawer>'
}, {
  name: "Medium",
  code: '<Drawer title="Drawer Heading" width="medium" open={true}>\n        <Placeholder width="100%" height={100} />\n      </Drawer>'
}, {
  name: "Large",
...
const snippets$r = [{
  ...
  name: "Level 1 (Weak)",
  code: '<Heading level="1" weight="weak">\n        Heading\n      </Heading>'
}, {
  name: "Level 1 (centered)",
  code: '<Heading level="1" align="center">\n        Heading\n      </Heading>'
}, {
  name: "Level 2",
  code: '<Heading level="2">Heading</Heading>'
}, {
  name: "Level 2 (Weak)",
  code: '<Heading level="2" weight="weak">\n        Heading\n      </Heading>'
}, {
  name: "Level 3",
  code: '<Heading level="3">Heading</Heading>'
}, {
  name: "Level 3 (Weak)",
  code: '<Heading level="3" weight="weak">\n        Heading\n      </Heading>'
}, {
  name: "Level 4",
...
const snippets$p = [{
  ...
  name: "Small Space",
  code: '<List space="small">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Medium Space",
  code: '<List space="medium">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Secondary",
  code: '<List space="medium" tone="secondary">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Numbered",
  code: '<List space="medium" type="number">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Alpha",
  code: '<List space="medium" type="alpha">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Roman",
  code: '<List space="medium" type="roman">\n        <Text>Text</Text>\n        <Text>Text</Text>\n        <Text>Text</Text>\n      </List>'
}, {
  name: "Icon",
...
const snippets$n = [{
  ...
  name: "With a positive message",
  code: '<MonthPicker label="Month" tone="positive" message="Positive message" />'
}, {
...
const snippets$m = [{
  ...
  name: "Positive",
  code: '<Notice tone="positive">\n        <Text>Positive Notice</Text>\n      </Notice>'
}, {
  name: "Info",
  code: '<Notice tone="info">\n        <Text>Info Notice</Text>\n      </Notice>'
}, {
  name: "Promote",
...
const snippets$g = [{
  ...
  name: "With a critical message",
  code: '<RadioGroup label="Label" tone="critical" message="Critical message">\n        <RadioItem label="One" value="1" />\n        <RadioItem label="Two" value="2" />\n      </RadioGroup>'
}, {
  name: "With a description",
  code: '<RadioGroup label="Label" description="More details about options">\n        <RadioItem label="One" value="1" />\n        <RadioItem label="Two" value="2" />\n      </RadioGroup>'
}, {
...
const snippets$f = [{
  ...
  code: '<Rating rating={4.2} variant="starsOnly" />'
}, {
  name: "Variant: minimal",
  code: '<Rating rating={3.7} variant="minimal" />'
}];
const snippets$e = [{
  name: "Standard",
...
const snippets = Object.entries({
  ...
  Tag: snippets$9,
  Text: snippets$8,
  TextDropdown: snippets$7,
  TextField: snippets$6,
  TextLink: snippets$5,
  Textarea: snippets$4,
  Tiles: snippets$3,
  Toggle: snippets$2,
  TooltipRenderer: snippets$1
}).map(
  ([group, snippets2]) => snippets2.map((snippet) => ({
    ...snippet,
    group
  }))
).flat();
